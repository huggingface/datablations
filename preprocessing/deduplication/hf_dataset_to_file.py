...
parser.add_argument("--save_dir", type=str, default="/mnt/disks/looking_glass_storage/lumi/dedup/")
parser.add_argument("--source_dir", type=str, default="/mnt/disks/looking_glass_storage/lumi/preprocessed_data/")
...
save_dir = args.save_dir + "/" + dataset_name
